#!/usr/bin/env python3
"""NTK Desk — Layer 1: Ingest.

Polls every feed in feeds.json (RSS 2.0, Atom, Google News sitemaps),
normalizes items, and maintains data/window.json — a rolling 48-hour
window of everything the 91 publishers have published.
...
DATA = ROOT / "data"
WINDOW_HOURS = 48
UA = "NTKDeskBot/0.1 (+https://ntknews.org; editorial monitoring)"
TIMEOUT = 15
